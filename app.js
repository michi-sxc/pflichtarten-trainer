...
const elements = {
  ...
  audioSpectrum: $("#audio-spectrum"), audioSpectrumBase: $("#audio-spectrum-base"),
  audioSpectrumPlayed: $("#audio-spectrum-played"), audioSpectrumPlayhead: $("#audio-spectrum-playhead"),
  audioSpectrumNote: $("#audio-spectrum-note"), audioError: $("#audio-error"), newAudio: $("#new-audio"),
